...
#include "emissive_scroll_blended_pass_v2_vs20.inc"
#include "emissive_scroll_blended_pass_v2_ps20.inc"
#include "emissive_scroll_blended_pass_v2_ps20b.inc"

#ifndef _X360
#include "emissive_scroll_blended_pass_v2_vs30.inc"
#include "emissive_scroll_blended_pass_v2_ps30.inc"
#endif
								   ...
								   IShaderShadow* pShaderShadow, EmissiveScrollBlendedPassVars_t &info, VertexCompressionType_t vertexCompression )
{
	SHADOW_STATE
	{
		...
		{
			// Vertex Shader
			DECLARE_STATIC_VERTEX_SHADER( emissive_scroll_blended_pass_v2_vs20 );
			SET_STATIC_VERTEX_SHADER( emissive_scroll_blended_pass_v2_vs20 );

			// Pixel Shader
			if( g_pHardwareConfig->SupportsPixelShaders_2_b() )
			{
				DECLARE_STATIC_PIXEL_SHADER( emissive_scroll_blended_pass_v2_ps20b );
				SET_STATIC_PIXEL_SHADER( emissive_scroll_blended_pass_v2_ps20b );
			}
			else
			{
				DECLARE_STATIC_PIXEL_SHADER( emissive_scroll_blended_pass_v2_ps20 );
				SET_STATIC_PIXEL_SHADER( emissive_scroll_blended_pass_v2_ps20 );
			}
		}
#ifndef _X360
		else
		{
			...
			DECLARE_STATIC_VERTEX_SHADER( emissive_scroll_blended_pass_v2_vs30 );
			SET_STATIC_VERTEX_SHADER( emissive_scroll_blended_pass_v2_vs30 );

			DECLARE_STATIC_PIXEL_SHADER( emissive_scroll_blended_pass_v2_ps30 );
			SET_STATIC_PIXEL_SHADER( emissive_scroll_blended_pass_v2_ps30 );
		}
#endif
	...
	DYNAMIC_STATE
	{
...
#endif
		{
			...
			DECLARE_DYNAMIC_VERTEX_SHADER( emissive_scroll_blended_pass_v2_vs20 );
			SET_DYNAMIC_VERTEX_SHADER_COMBO( SKINNING, pShaderAPI->GetCurrentNumBones() > 0 );
			SET_DYNAMIC_VERTEX_SHADER_COMBO( COMPRESSED_VERTS, (int)vertexCompression );
			SET_DYNAMIC_VERTEX_SHADER( emissive_scroll_blended_pass_v2_vs20 );
			...
			if( g_pHardwareConfig->SupportsPixelShaders_2_b() )
			{
				DECLARE_DYNAMIC_PIXEL_SHADER( emissive_scroll_blended_pass_v2_ps20b );
				SET_DYNAMIC_PIXEL_SHADER( emissive_scroll_blended_pass_v2_ps20b );
			}
			else
			{
				DECLARE_DYNAMIC_PIXEL_SHADER( emissive_scroll_blended_pass_v2_ps20 );
				SET_DYNAMIC_PIXEL_SHADER( emissive_scroll_blended_pass_v2_ps20 );
			}
		}
#ifndef _X360
		else
		{
			...
			// Set Vertex Shader Combos
			DECLARE_DYNAMIC_VERTEX_SHADER( emissive_scroll_blended_pass_v2_vs30 );
			SET_DYNAMIC_VERTEX_SHADER_COMBO( SKINNING, pShaderAPI->GetCurrentNumBones() > 0 );
			SET_DYNAMIC_VERTEX_SHADER_COMBO( MORPHING, bHasFastVertexTextures && pShaderAPI->IsHWMorphingEnabled() );
			SET_DYNAMIC_VERTEX_SHADER_COMBO( COMPRESSED_VERTS, (int)vertexCompression );
			SET_DYNAMIC_VERTEX_SHADER( emissive_scroll_blended_pass_v2_vs30 );

			DECLARE_DYNAMIC_PIXEL_SHADER( emissive_scroll_blended_pass_v2_ps30 );
			SET_DYNAMIC_PIXEL_SHADER( emissive_scroll_blended_pass_v2_ps30 );
		}
#endif
