...
#define DEFRTNAME_WORLDPOS "_rt_def_WorldPos"
 ...
 */
#	define FREE_LIGHT_SAMPLERS			12
#	define FIRST_LIGHT_SAMPLER			4
#	define FIRST_LIGHT_SAMPLER_FXC		s4

#if FREE_LIGHT_SAMPLERS < MAX_LIGHTS_SHADOWEDCOOKIE * 2 + MAX_LIGHTS_SHADOWED + MAX_LIGHTS_COOKIE
#error "Not enough samplers to store all textures!"
#endif
