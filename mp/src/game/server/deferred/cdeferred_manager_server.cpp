...
static ConVar deferred_no_light_generation( "deferred_no_light_generation", "0", 0, "", true, 0, true, 1 );

void CDeferredManagerServer::LevelInitPreEntity()
{
	//return;
	if ( gpGlobals->eLoadType == MapLoad_LoadGame || deferred_no_light_generation.GetBool() )
		return;
